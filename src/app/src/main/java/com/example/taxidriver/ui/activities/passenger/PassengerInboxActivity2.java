    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        load.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                viewModel.getMessages().observe(PassengerInboxActivity2.this, messageDTOList -> {
...
//                                fragmentManager.beginTransaction().remove(DriverInboxFragment.newInstance(messageDTOList, panic.isChecked(), panic.isChecked(), ride.isChecked())).commit();
        ...
        home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(PassengerInboxActivity2.this, PassengerMainActivity.class));
                finish();
        ...
        history.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(PassengerInboxActivity2.this, PassengerHistoryActivity.class));
                finish();
        ...
        inbox.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(PassengerInboxActivity2.this, PassengerInboxActivity2.class));
                finish();
        ...
        profile.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(PassengerInboxActivity2.this, DriverAccountActivity.class));
                finish();
